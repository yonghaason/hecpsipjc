...
$n=2^{20}$, $L=32$에서 \cite{KLS26} 대비 통신량은 32.4\%, LAN 실행 시간은 59.5\% 감소하며, 정수 inner product를 위한 $L=84$ 설정에서는 제안 프로토콜의 비용이 $1.56$배 증가하는 동안 \cite{KLS26}의 비용은 MultShare의 이차 증가로 한 자릿수 배 이상 증가한다.
...
\midrule
\multirow{2}{*}{$2^{16}$}
& \cite{KLS26} & KLSCOMM16 & KLSTIME16 \\
& \textbf{Ours} & 21.832 & 0.823 \\
\midrule
\multirow{2}{*}{$2^{20}$}
& \cite{KLS26} & KLSCOMM20 & KLSTIME20 \\
...
MultShare의 이차 증가로 KLSRATIO20배가 된다.
...
KLSRATIO20배가 되어 격차가 더 벌어졌다. 이는 payload가 길어질수록 $O(\ell)$
