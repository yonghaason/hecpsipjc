...
\section{Leakage in the PJC Instantiation of~\cite{LTS+26}}\label{sec:cryptanalysis}
...
\subsection{Reconstructing the PJC Computation of~\cite{LTS+26}}\label{sec:LTSprotocol}
...
향후 연구에서는 정수 inner product 설정을 WAN 환경까지 확장하여 측정하고, 전체 실행 시간과
