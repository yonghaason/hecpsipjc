...
본 절에서는 제안 프로토콜이 semi-honest adversary에 대해 안전함을 보인다.
증명은 두 층으로 나누어 진행한다. 먼저 AF-CPSI가 $\func{AF-CPSI}$를
realize함을 보이고, 이를 ideal functionality로 두고 제안 PJC 프로토콜이
$\func{PJC}$를 realize함을 보인다.
...
\subsection{Security of AF-CPSI}\label{sec:security-afcpsi}
...
\subsection{Security of the Proposed PJC Protocol}\label{sec:security-pjc}
