...
LAN. When the arithmetic space is widened to 84 bits, as an exact integer
inner product over 32-bit payloads requires, our communication grows by
$1.56\times$ while the quadratic baseline grows by $4.65\times$.
\end{abstract}
